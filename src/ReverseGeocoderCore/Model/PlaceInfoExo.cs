...
{
    internal class PlaceInfoExo : IKdComparator<PlaceInfoExo>, IPlaceInfo
    {
        ...
        //public PlaceInfoExo(string geoEntry)
        //{
        ...
        //public PlaceInfoExo(double latitude, double longitude)
        //{
        //    Latitude = latitude;
        //    Longitude = longitude;
        //}

        double IKdComparator<PlaceInfoExo>.AxisSquaredDistance(PlaceInfoExo location, Axis axis)
        {
            double distance;
            switch (axis)
            {
        ...
        IComparer<PlaceInfoExo> IKdComparator<PlaceInfoExo>.Comparator(Axis axis)
        {
            switch (axis)
            {
        ...
        double IKdComparator<PlaceInfoExo>.SquaredDistance(PlaceInfoExo location)
        {
            var x = X - location.X;
            var y = Y - location.Y;
            var z = Z - location.Z;
        ...
        private class CompareX : IComparer<PlaceInfoExo>
        {
            public int Compare(PlaceInfoExo x, PlaceInfoExo y)
            {
                if (x == null && y == null)
                {
                    return 0;
        ...
        private class CompareY : IComparer<PlaceInfoExo>
        {
            public int Compare(PlaceInfoExo x, PlaceInfoExo y)
            {
                if (x == null && y == null)
        ...
        private class CompareZ : IComparer<PlaceInfoExo>
        {
            public int Compare(PlaceInfoExo x, PlaceInfoExo y)
            {
                if (x == null && y == null)
